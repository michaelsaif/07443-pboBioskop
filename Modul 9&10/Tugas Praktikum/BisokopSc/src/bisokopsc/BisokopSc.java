...
import bisokopsc.PesanTiket;

public class BisokopSc {
    ...
    public BisokopSc() {
        do {
            ...
            if (menu == 1) {
                ...
                System.out.println("1. Cinta Subuh (Romance)");
                System.out.println("2. The Doll 3 (Horror)");
                System.out.println("3. Gara Gara Warisan (Comedy)");
                System.out.println("4. Garis Waktu (Romance)");
                System.out.println("5. Wanita Tanah Jahanam (Horror)");
                System.out.println("Masukkan Pilihan : ");
                int choiceflm = input.nextInt();
                if (choiceflm == 1) {
                    kode = "A185 >> Cinta Subuh (Romance)";
                } else if (choiceflm == 2) {
                    kode = "A302 >> The Doll 3 (Horror)";
                } else if (choiceflm == 3) {
                    kode = "A273 >> Gara Gara Warisan (Comedy)";
                } else if (choiceflm == 4) {
                    kode = "A142 >> Garis Waktu (Romance)";
                } else {
                    kode = "A331 >> Wanita Tanah Jahanam (Horror)";
                }
    ...
    public static void main(String[] args) {
        System.out.println("================================");
        Welcome welcome1 = new Welcome("HELLO GUYS");
        Welcome welcome2 = new Welcome("WELCOME TO CINEMA XXI");
        Welcome welcome3 = new Welcome();
        
        welcome1.showWelcome();
        welcome2.showWelcome();
        welcome3.showWelcome("");
        
        BisokopSc xxi = new BisokopSc();
